...
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['clinic', 'addr_soi', 'alias_name', 'employer_name'], 'string', 'max' => 100],
            ...
            [['cid', 'father_cid', 'mother_cid', 'couple_cid', 'employer_cid'], 'string', 'max' => 13],
