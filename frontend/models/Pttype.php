...
class Pttype extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['isuse', 'requirecode', 'doctor_fee', 'contract', 'in_region', 'uc', 'require_hcode', 'debtor', 'noexpire', 'bill_sss', 'use_contract_id', 'yearly_charge', 'allow_finance_edit', 'print_csmb_statement', 'rx_pay_debit_tr', 'separate_rcpno', 'separate_debt_id', 'use_package', 'charge_df_perday', 'print_presc_ned', 'export_eclaim', 'round_money', 'emp_privilege', 'is_pttype_plan'], 'string', 'max' => 1],
            ...
            [['hipdata_pttype', 'pttype_group1', 'pttype_group2', 'province_code', 'thailand_code'], 'string', 'max' => 3],
